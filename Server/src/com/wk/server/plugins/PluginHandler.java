...
import com.wk.server.event.custom.ShopRestockEvent;
...
public final class PluginHandler {
	...
	public void initPlugins() throws Exception {
		...
		for (final Class<?> interfce : loadInterfaces("com.wk.server.plugins.listeners.action")) {
		...
		for (final Class<?> interfce : loadInterfaces("com.wk.server.plugins.listeners.executive")) {
