...
import com.wk.server.net.rsc.handlers.AttackHandler;
import com.wk.server.net.rsc.handlers.BankHandler;
import com.wk.server.net.rsc.handlers.BlinkHandler;
import com.wk.server.net.rsc.handlers.ChatHandler;
import com.wk.server.net.rsc.handlers.CommandHandler;
import com.wk.server.net.rsc.handlers.FriendHandler;
import com.wk.server.net.rsc.handlers.GameObjectAction;
import com.wk.server.net.rsc.handlers.GameObjectWallAction;
import com.wk.server.net.rsc.handlers.GameSettingHandler;
import com.wk.server.net.rsc.handlers.GroundItemTake;
import com.wk.server.net.rsc.handlers.InterfaceOptionHandler;
import com.wk.server.net.rsc.handlers.InterfaceShopHandler;
import com.wk.server.net.rsc.handlers.ItemActionHandler;
import com.wk.server.net.rsc.handlers.ItemDropHandler;
import com.wk.server.net.rsc.handlers.ItemUseOnGroundItem;
import com.wk.server.net.rsc.handlers.ItemUseOnItem;
import com.wk.server.net.rsc.handlers.ItemUseOnNpc;
import com.wk.server.net.rsc.handlers.ItemUseOnObject;
import com.wk.server.net.rsc.handlers.ItemUseOnPlayer;
import com.wk.server.net.rsc.handlers.ItemWieldHandler;
import com.wk.server.net.rsc.handlers.Logout;
import com.wk.server.net.rsc.handlers.LogoutRequest;
import com.wk.server.net.rsc.handlers.MenuReplyHandler;
import com.wk.server.net.rsc.handlers.NpcCommand;
import com.wk.server.net.rsc.handlers.NpcTalkTo;
import com.wk.server.net.rsc.handlers.Ping;
import com.wk.server.net.rsc.handlers.PlayerAppearanceUpdater;
import com.wk.server.net.rsc.handlers.PlayerDuelHandler;
import com.wk.server.net.rsc.handlers.PlayerFollowRequest;
import com.wk.server.net.rsc.handlers.PlayerTradeHandler;
import com.wk.server.net.rsc.handlers.PrayerHandler;
import com.wk.server.net.rsc.handlers.PrivacySettingHandler;
import com.wk.server.net.rsc.handlers.ReportHandler;
import com.wk.server.net.rsc.handlers.SleepHandler;
import com.wk.server.net.rsc.handlers.SpellHandler;
import com.wk.server.net.rsc.handlers.StyleHandler;
import com.wk.server.net.rsc.handlers.TutorialHandler;
import com.wk.server.net.rsc.handlers.WalkRequest;
