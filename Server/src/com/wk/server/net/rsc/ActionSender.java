...
import com.wk.server.GameStateUpdater;
...
import com.wk.server.content.clan.ClanPlayer;
...
import com.wk.server.util.rsc.CaptchaGenerator;
...
public class ActionSender {
	...
	public static void hideBank(Player player) {
		com.wk.server.net.PacketBuilder s = new com.wk.server.net.PacketBuilder();
	...
	public static void sendOwnDuelAcceptUpdate(Player player) {
		...
		com.wk.server.net.PacketBuilder s1 = new com.wk.server.net.PacketBuilder();
	...
	public static void sendInputBox(Player player, String s) {
		com.wk.server.net.PacketBuilder pb = new com.wk.server.net.PacketBuilder();
		pb.setID(110);
		pb.writeString(s);
		player.write(pb.toPacket());
	}
