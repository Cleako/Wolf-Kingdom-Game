...
import static com.legacy.server.plugins.Functions.PRAYER;
import static com.legacy.server.plugins.Functions.WOODCUT;
import static com.legacy.server.plugins.Functions.addItem;
import static com.legacy.server.plugins.Functions.atQuestStage;
import static com.legacy.server.plugins.Functions.atQuestStages;
import static com.legacy.server.plugins.Functions.attack;
import static com.legacy.server.plugins.Functions.completeQuest;
...
import static com.legacy.server.plugins.Functions.getQuestStage;
import static com.legacy.server.plugins.Functions.getWoodcutAxe;
import static com.legacy.server.plugins.Functions.hasItem;
import static com.legacy.server.plugins.Functions.inArray;
import static com.legacy.server.plugins.Functions.isNpcNearby;
import static com.legacy.server.plugins.Functions.isWielding;
import static com.legacy.server.plugins.Functions.kill;
...
import static com.legacy.server.plugins.Functions.setCurrentLevel;
import static com.legacy.server.plugins.Functions.setQuestStage;
