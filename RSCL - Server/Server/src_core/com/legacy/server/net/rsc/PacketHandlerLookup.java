...
import com.legacy.server.net.rsc.handlers.AttackHandler;
import com.legacy.server.net.rsc.handlers.BankHandler;
import com.legacy.server.net.rsc.handlers.BlinkHandler;
import com.legacy.server.net.rsc.handlers.ChatHandler;
import com.legacy.server.net.rsc.handlers.CommandHandler;
import com.legacy.server.net.rsc.handlers.FriendHandler;
import com.legacy.server.net.rsc.handlers.GameObjectAction;
import com.legacy.server.net.rsc.handlers.GameObjectWallAction;
import com.legacy.server.net.rsc.handlers.GameSettingHandler;
import com.legacy.server.net.rsc.handlers.GroundItemTake;
import com.legacy.server.net.rsc.handlers.InterfaceOptionHandler;
import com.legacy.server.net.rsc.handlers.InterfaceShopHandler;
import com.legacy.server.net.rsc.handlers.ItemActionHandler;
import com.legacy.server.net.rsc.handlers.ItemDropHandler;
import com.legacy.server.net.rsc.handlers.ItemUseOnGroundItem;
import com.legacy.server.net.rsc.handlers.ItemUseOnItem;
import com.legacy.server.net.rsc.handlers.ItemUseOnNpc;
import com.legacy.server.net.rsc.handlers.ItemUseOnObject;
import com.legacy.server.net.rsc.handlers.ItemUseOnPlayer;
import com.legacy.server.net.rsc.handlers.ItemWieldHandler;
import com.legacy.server.net.rsc.handlers.Logout;
import com.legacy.server.net.rsc.handlers.LogoutRequest;
import com.legacy.server.net.rsc.handlers.MenuReplyHandler;
import com.legacy.server.net.rsc.handlers.NpcCommand;
import com.legacy.server.net.rsc.handlers.NpcTalkTo;
import com.legacy.server.net.rsc.handlers.Ping;
import com.legacy.server.net.rsc.handlers.PlayerAppearanceUpdater;
import com.legacy.server.net.rsc.handlers.PlayerDuelHandler;
import com.legacy.server.net.rsc.handlers.PlayerFollowRequest;
import com.legacy.server.net.rsc.handlers.PlayerTradeHandler;
import com.legacy.server.net.rsc.handlers.PrayerHandler;
import com.legacy.server.net.rsc.handlers.PrivacySettingHandler;
import com.legacy.server.net.rsc.handlers.ReportHandler;
import com.legacy.server.net.rsc.handlers.SleepHandler;
import com.legacy.server.net.rsc.handlers.SpellHandler;
import com.legacy.server.net.rsc.handlers.StyleHandler;
import com.legacy.server.net.rsc.handlers.TutorialHandler;
import com.legacy.server.net.rsc.handlers.WalkRequest;
