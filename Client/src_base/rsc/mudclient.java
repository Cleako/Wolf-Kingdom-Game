...
import com.wk.client.data.DataFileDecrypter;
import com.wk.client.data.DataOperations;
import com.wk.client.entityhandling.EntityHandler;
import com.wk.client.entityhandling.defs.ItemDef;
import com.wk.client.entityhandling.defs.NPCDef;
import com.wk.client.entityhandling.defs.SpellDef;
import com.wk.client.entityhandling.defs.extras.AnimationDef;
import com.wk.client.model.Sprite;
import com.wk.interfaces.NComponent;
import com.wk.interfaces.misc.AuctionHouse;
import com.wk.interfaces.misc.BankInterface;
import com.wk.interfaces.misc.BankPinInterface;
import com.wk.interfaces.misc.FishingTrawlerInterface;
import com.wk.interfaces.misc.IronManInterface;
import com.wk.interfaces.misc.OnlineListInterface;
import com.wk.interfaces.misc.ProgressBarInterface;
import com.wk.interfaces.misc.QuestGuideInterface;
import com.wk.interfaces.misc.SkillGuideInterface;
import com.wk.interfaces.misc.ExperienceConfigInterface;
import com.wk.interfaces.misc.DoSkillInterface;
import com.wk.interfaces.misc.LostOnDeathInterface;
import com.wk.interfaces.misc.TerritorySignupInterface;
import com.wk.interfaces.misc.clan.Clan;
import com.wk.interfaces.NCustomComponent;
	...
	private final int[][] animDirLayer_To_CharLayer = new int[][] { { 11, 2, 9, 7, 1, 6, 10, 0, 5, 8, 3, 4 },
		...
		private final void createLoginPanels(int var1) {
			try {
				...
				if(Config.isAndroid())
					var2 = -125;
				this.panelLoginWelcome.addCenteredText(256, 190 + var2, "Welcome to Wolf Kingdom", 4, true);
				String var3 = null;
