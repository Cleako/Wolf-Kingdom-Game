		...
		case "delete_character":
			...
			if (isset($_GET['key'])) {
				...
				if($cur_user['jewels'] < 100) 
					message(__('You need to have 100 jewels in order for this service. You can donate for jewels at: <a href="www.rsclegacy.com/donate.php">www.rsclegacy.com/donate.php</a>', 'luna').'');
				else {
...
(Do not reply to this message)', 'luna'));
						...
						while ($cur_hit = $db->fetch_assoc($result)) {
							...
							if($cur_hit['jewels'] < 100) {
								message(__('This service cost 100 jewels, you can donate for more jewels at: <a href="http://www.rsclegacy.com/donate.php">www.rsclegacy.com/donate.php</a>', 'luna'));
							}
