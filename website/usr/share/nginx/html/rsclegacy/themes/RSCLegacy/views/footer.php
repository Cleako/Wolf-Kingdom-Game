...
<div class="container">
	<div class="col-md-3 col-sm-6 hidden-xs">
		<div class="footer-info-single">
			...
			<ul class="list-unstyled">
				<li><a href="http://www.rsclegacy.com" title=""><i class="fa fa-angle-double-right"></i> Home</a></li>
				<li><a href="http://www.rsclegacy.com/forum.php" title=""><i class="fa fa-angle-double-right"></i> Forum</a></li>
				<li><a href="http://www.rsclegacy.com/donate.php" title=""><i class="fa fa-angle-double-right"></i> Donate</a></li>
				<li><a href="http://www.rsclegacy.com/shop.php" title=""><i class="fa fa-angle-double-right"></i> Shop</a></li>
			</ul>
		</div>
	</div>
	<div class="col-md-3 col-sm-6 hidden-xs">
		<div class="footer-info-single">
			...
			<ul class="list-unstyled">
				<li><a href="http://www.rsclegacy.com/guide.php" title=""><i class="fa fa-angle-double-right"></i> Guides</a></li>
				<li><a href="http://www.rsclegacy.com/help.php" title=""><i class="fa fa-angle-double-right"></i> Forum Help</a></li>
				<li><a href="http://www.rsclegacy.com/about.php" title=""><i class="fa fa-angle-double-right"></i> Staff, FAQ & About Us</a></li>
				<li><a href="http://www.rsclegacy.com/terms.php" title=""><i class="fa fa-angle-double-right"></i> ToS / Rules</a></li>
			</ul>
		</div>
	</div>
	<div class="col-md-3 col-sm-6 hidden-xs">
		<div class="footer-info-single">
			...
			<ul class="list-unstyled">
				<li><a href="http://www.rsclegacy.com/highscore.php" title=""><i class="fa fa-angle-double-right"></i> Highscore</a></li>
				<li><a href="http://www.rsclegacy.com/calculators.php" title=""><i class="fa fa-angle-double-right"></i> Calculators</a></li>
				<li><a href="http://www.rsclegacy.com/db.php" title=""><i class="fa fa-angle-double-right"></i> RSCLegacy Database</a></li>
				<li><a href="http://www.rsclegacy.com/guide.php?m=game_guide" title=""><i class="fa fa-angle-double-right"></i> Play Now</a></li>
			</ul>
		</div>
	</div>
	<div class="col-md-3 col-sm-6">
		<div class="footer-info-single">
			...
			<p><a href="http://www.rsclegacy.com">RSCLegacy</a> is in no-way affiliated with <a href="http://www.jagex.com">Jagex Games Studio</a> or their games. Any references are made for identification purposes only.
