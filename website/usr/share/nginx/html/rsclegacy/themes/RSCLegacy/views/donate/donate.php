...
<div class="don_container">
	...
	<div class="col-sm-8 left-check">
		...
		<form id="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="POST">
			...
			<input type="hidden" name="business" value="service@rsclegacy.com" />
			...
			<input type="hidden" name="return" value="http://www.rsclegacy.com/donate.php?thank_you" /> 
			<input type="hidden" name="rm" value="2" /> 
			<input type="hidden" name="notify_url" value="http://www.rsclegacy.com/paypal/ipn.php" />
		</form>
	</div>
