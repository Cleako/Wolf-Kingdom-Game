...
<div class="col-sm-3 sidebar content-l-side">
	<div class="list-group list-group-luna">				
		...
		{
			echo "<a class='" . ($curr_skill == $s_skills[$i] ? " active" : "") . " list-group-item' href='calculators.php?skill=" . $s_skills[$i] . "'><img src='http://rsclegacy.com/img/skills/" . $s_skills[$i] . ".gif' alt='*' style='vertical-align:bottom;' />&nbsp;" . ucfirst($s_skills[$i]) . "</a>";
		}
		?>
	</div>
</div>
